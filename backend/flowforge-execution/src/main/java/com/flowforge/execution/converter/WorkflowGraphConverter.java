package com.flowforge.execution.converter;
...
public class WorkflowGraphConverter implements AttributeConverter<WorkflowGraph, String> {
    ...
    public String convertToDatabaseColumn(WorkflowGraph graph) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Failed to serialize WorkflowGraph to JSON", e);
        }
    }
    ...
    public WorkflowGraph convertToEntityAttribute(String dbData) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Failed to deserialize JSON to WorkflowGraph", e);
        }
    }
}
